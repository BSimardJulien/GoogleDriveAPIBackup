...
class MyDrive():
    ...
    def upload_file(self,filename,path,logger):
        folder_id = "1V2fzlHFnCjZL8DZX3DV3SC4nIqJ9f1Hi"
...
class MyLogger():
    def __init__(self):
        ...
        filepath = "D:/Source/Python Project/Backup KeePass Script/logging.log"
...
def main():
    path = "D:/Documentation/Groupe/INFORMATIQUE/"
    file = "CLBPassword.kdbx"

    my_logger = MyLogger()
    my_drive = MyDrive()
    try:
        my_drive.upload_file(file,path,my_logger)
